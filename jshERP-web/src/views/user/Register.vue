    ...
    >
      <a-form-item
        ...
        :fieldDecoratorOptions="{
          rules: [{ required: true, message: '用户名不能为空' }, { validator: this.handleUserName }],
      ...
      <a-row :gutter="0">
        <a-col :span="16">
          <a-form-item fieldDecoratorId="inputCode">
            ...
            <a-input size="large" type="text" default-value="" placeholder="请输入验证码">
      ...
      <div class="login-copyright">
        <a-row>
          <a-col>
            ...
            <span v-if="showWeixinSpan()" class="weixin" @mouseover="showWeixin" @click="changeWeixinStatus"
              >微信小程序</span
            >
          </a-col>
        </a-row>
...
export default {
  ...
  methods: {
    handleChangeCheckCode() {
      ...
      getAction(`/user/randomImage/${this.currdatetime}`)
        .then((res) => {
          if (res.code == 200) {
