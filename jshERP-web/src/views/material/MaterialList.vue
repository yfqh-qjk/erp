    ...
    <a-col :md="24">
      <a-card :style="cardStyle" :bordered="false">
        ...
        <div class="table-operator" style="margin-top: 5px">
          ...
          <a-button v-if="btnEnableList.indexOf(1) > -1" @click="handleImportXls()" type="primary" icon="import"
            >导入</a-button
          >
          ...
          <a-dropdown>
            <a-menu slot="overlay">
              ...
              >
              <a-menu-item key="4" v-if="btnEnableList.indexOf(1) > -1" @click="batchEdit()"
                ><a-icon type="edit" />批量编辑</a-menu-item
              >
              <a-menu-item key="5" v-if="btnEnableList.indexOf(1) > -1" @click="batchSetMaterialCurrentStock()"
