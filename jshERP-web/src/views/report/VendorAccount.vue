        ...
        <div class="table-page-search-wrapper">
          <a-form layout="inline" @keyup.enter.native="searchQuery">
            <a-row :gutter="24">
              ...
              <a-col :md="6" :sm="24">
                <a-form-item> {{ firstTotal }} {{ lastTotal }} </a-form-item>
              </a-col>
            </a-row>
          </a-form>
        </div>
...
export default {
  ...
  data() {
    return {
      ...
      columns: [
        ...
        { title: '欠款详情', dataIndex: 'action', align: 'center', width: 80, scopedSlots: { customRender: 'action' } },
  ...
  methods: {
    ...
    exportExcel() {
      let aoa = [
        ['供应商', '联系人', '手机号码', '联系电话', '电子邮箱', '期初应付', '本期欠款', '本期付款', '期末应付'],
      ];
    ...
    showDebtAccountList(record) {
      this.$refs.debtAccountList.show(
        record.id,
        '入库',
        '采购',
        '供应商',
